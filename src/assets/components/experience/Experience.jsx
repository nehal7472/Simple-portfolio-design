      ...
      <div className="flex flex-col gap-16">
        <div className="flex flex-col md:flex-row gap-8">
          <div className="w-full md:w-[600px] flex flex-col justify-center  items-center md:items-end  gap-4 border-gray-500 md:border-r-2 pr-0 md:pr-8">
            ...
            <div>
              <p className="text-center md:text-right">Apr 2022 - May 204</p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-[600px] flex flex-col justify-center items-center md:items-start gap-4 border-gray-500 md:border-l-2 pl-0 md:pl-8">
